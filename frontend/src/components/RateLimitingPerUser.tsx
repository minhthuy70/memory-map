...
import { Gauge, X, Settings, AlertTriangle } from 'lucide-react';

interface RateLimitingPerUserProps {
  onCancel?: () => void;
}

export default function RateLimitingPerUser({ onCancel }: RateLimitingPerUserProps) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-slate-900 dark:text-white text-lg">
              Giới hạn tốc độ mỗi người dùng
            </h3>
      ...
      <div className="p-4 bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-900 rounded-lg">
        <p className="text-xs text-purple-700 dark:text-purple-400">
          <strong>Đang phát triển:</strong> Giới hạn tốc độ mỗi người dùng ngăn chặn abuse từ từng user.
        </p>
      </div>
    </div>
  );
