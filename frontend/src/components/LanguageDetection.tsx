...
export default function LanguageDetection({ onCancel }: LanguageDetectionProps) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Tự động phát hiện ngôn ngữ nội dung
            </p>
          </div>
        </div>
      ...
      <div className="p-4 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-900 rounded-lg">
        <p className="text-xs text-green-700 dark:text-green-400">
          <strong>Đang phát triển:</strong> Phát hiện ngôn ngữ sử dụng NLP để xác định ngôn ngữ của nội dung.
        </p>
      </div>
    </div>
  );
