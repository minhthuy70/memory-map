import { Activity, AlertCircle, AlertTriangle, AlignCenter, AlignLeft, AlignRight, BarChart3, Calendar, Check, CheckCircle, Clock, Clock as ClockIcon, Copyright, CreditCard, DollarSign, Download, Download as DownloadIcon, ExternalLink, Eye, EyeOff, FileText, Filter, FlipHorizontal, Image, Image as ImageIcon, Layers, LayoutGrid, Maximize2, Minimize2, Package, Palette, Pause, Play, Plus, Printer, RefreshCw, RotateCw, Settings, Settings as SettingsIcon, Share2, Sparkles, Trash2, Trash2 as TrashIcon, Truck, Type, Type as TypeIcon, X, Zap, Zap as ZapIcon, ZoomIn, ZoomOut } from 'lucide-react';
'use client';
