...
import { LayoutGrid, X, Settings, AlertTriangle } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
      ...
      <div className="p-4 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-900 rounded-lg">
        <p className="text-xs text-indigo-700 dark:text-indigo-400">
          <strong>Đang phát triển:</strong> Widgets cho phép hiển thị thông tin kỷ niệm trên màn hình chính.
        </p>
      </div>
    </div>
  );
