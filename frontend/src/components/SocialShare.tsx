...
import { as, Check, Link, LinkIcon, Share2 } from 'lucide-react';
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        aria-label="Chia sẻ lên Globe2"
        title="Chia sẻ lên Globe2"
      >
      ...
      <button
        ...
        className="p-2 bg-sky-500 rounded-lg hover:bg-sky-600 transition-colors"
        aria-label="Chia sẻ lên MessageCircle"
        title="Chia sẻ lên MessageCircle"
      >
        <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        {copied ? (
          ...
          <LinkIcon className="h-5 w-5 text-slate-700 dark:text-slate-300" />
        )}
      </button>
    </div>
  );
