...
import { MessageSquare, X, Settings, AlertTriangle } from 'lucide-react';

interface CommentsSystemProps {
  onCancel?: () => void;
}

export default function CommentsSystem({ onCancel }: CommentsSystemProps) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
      ...
      <div className="p-4 bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-900 rounded-lg">
        <p className="text-xs text-purple-700 dark:text-purple-400">
          <strong>Đang phát triển:</strong> Hệ thống bình luận cho phép người dùng bình luận trên kỷ niệm và trả lời bình luận.
        </p>
      </div>
    </div>
  );
