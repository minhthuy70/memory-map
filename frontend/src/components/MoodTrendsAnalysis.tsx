import { Activity, AlertTriangle, ArrowDown, ArrowUp, BarChart3, Calendar, CheckCircle, Clock, Frown, HeartCrack, Meh, Settings, Smile, Sparkles, TrendingUp, X } from 'lucide-react';
'use client';
