import { Activity, AlertTriangle, BarChart3, Calendar, Camera, CheckCircle, Clock, Eye, Filter, Image, Image as ImageIcon, Lock, Plus, Scan, Search, Settings, Shield, Smile, Trash2, Unlock, User, Users, X, Zap } from 'lucide-react';
'use client';
