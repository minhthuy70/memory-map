...
import { Check, X, RefreshCw, Info, CheckCircle, Star, Zap, Shield, Sparkles } from 'lucide-react';
...
export default function ProPlan({ onCancel }: ProPlanProps) {
  ...
  const [planFeatures, setPlanFeatures] = useState<PlanFeature[]>([
    ...
    { id: '2', name: 'Storage Space', description: 'Cloud storage for media', isIncluded: true, value: '100GB' },
    ...
    { id: '7', name: 'Priority Support', description: 'Priority customer support', isIncluded: true, value: '24/7' },
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              AI features, video, 100GB storage
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-lg font-bold text-purple-600 dark:text-purple-400">$19.99/mo</span>
          <button
            type="button"
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          <div className="p-3 bg-slate-50 dark:bg-slate-700/30 rounded-lg text-center">
            ...
            <p className="text-lg font-bold text-slate-900 dark:text-white">$19.99/mo</p>
          </div>
          <div className="p-3 bg-slate-50 dark:bg-slate-700/30 rounded-lg text-center">
          ...
          <div className="p-3 bg-slate-50 dark:bg-slate-700/30 rounded-lg text-center">
            ...
            <p className="text-lg font-bold text-blue-600 dark:text-blue-400">100GB</p>
          </div>
          <div className="p-3 bg-slate-50 dark:bg-slate-700/30 rounded-lg text-center">
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">AI Features</p>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs border-0 flex items-center gap-1 ${isSelected ? 'bg-purple-600 hover:bg-purple-700' : 'bg-slate-200 dark:bg-slate-700'} text-white`}
          >
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-600 rounded-lg">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-600 text-center">
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white">$19.99</p>
            </div>
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-600 text-center">
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Yearly</p>
              <p className="text-lg font-bold text-slate-900 dark:text-white">$199.99</p>
            ...
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-600 text-center">
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white">14 days</p>
            </div>
          </div>
        </div>
