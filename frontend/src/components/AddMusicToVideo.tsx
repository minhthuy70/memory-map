import { Activity, AlertTriangle, AudioLines, BarChart3, Calendar, Check, CheckCircle, Clock, Download, Filter, Layers, Music, Pause, Play, PlayCircle, Plus, RefreshCw, Settings, Settings as SettingsIcon, SkipBack, SkipForward, Sliders, Trash2, Trash2 as TrashIcon, Upload, Video, Volume2, VolumeX, X, Zap, Zap as ZapIcon } from 'lucide-react';
'use client';
